<footer class="bg-dark" style="margin-top: 5%;">
            <div class="container">
                <div class="row align-items-center pt-8 pb-4">
                    <div class="col-md mb-5 mb-md-0">
                        <h2 class="fw-medium text-white-70 mb-0"><span class="fw-bold text-white">Garazy</span> est avec vous!</h2>
                    </div>
                    <!-- End Col -->
                    <div class="col-md-auto">
                        <div class="d-grid d-sm-flex gap-3"><a class="btn btn-primary" href="#">Rendez-vous</a><a class="btn btn-ghost-light btn-pointer" href="<?php echo site_url('Login/LogoutAdmin'); ?>">Deconnexion</a>
                        </div>
                    </div>
                    <!-- End Col -->
                </div>
