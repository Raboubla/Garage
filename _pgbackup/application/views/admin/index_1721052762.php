...
<head>
    ...
    <!-- <link href="<?php echo base_url('assets/bootstrap/admin/bootstrap/css/bootstrap.min.css'); ?>" rel="stylesheet">
...
<body style="background-color: #000000;">
    <div class="container">
        <div class="row" style="margin-left: 34.373999999999995%; margin-top: 27.573%;">
