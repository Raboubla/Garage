...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../../../../../../assets/vendor/bootstrap-icons/font/bootstrap-icons.css">
        <link rel="stylesheet" href="../../../../../../pinekit_theme/pinekit.css">
        <link rel="stylesheet" href="../../../../../../css/style.css">
        <link href="../../../pinekit_theme/pinekit.css" rel="stylesheet" type="text/css">
    </head>
    <body>
        <header>
            <nav class="bg-white navbar navbar-expand-lg navbar-light">
                <div class="container"><a class="navbar-brand" href="#"></a>
                    ...
                    </button><span class="fw-bold placeholder-wave text-primary" style="font-size: 39px;">Garazy</span>
        ...
        <main role="main">
            <!-- Hero -->
            <div class="container content-space-t-3 lib-hero">
                <div class="row justify-content-lg-between align-items-lg-center">
                    <div class="col-lg-5 mb-5 mb-lg-0">
                        ...
                        <div class="d-grid d-sm-flex gap-3 mb-5">
                            <a class="btn btn-primary" href="#">Prendre des rendez-vous</a>
                            <a class="btn btn-ghost-dark btn-pointer" href="#">Notre services</a>
                        </div>
                    </div>
                    <!-- End Col -->
                    <div class="col-lg-6">
                        <div class="position-relative">
                            <div class="position-relative">
                                <img class="img-fluid" src="../../../assets/img/950x950/1.jpg" alt="Image Description">
                            ...
                            <div class="d-inline-block position-absolute top-0 start-0 bg-white w-100 rounded-pill shadow-sm p-2 mt-5 ms-n5" style="max-width: 12rem;">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <span class="avatar avatar-sm avatar-circle"> <img class="avatar-img" src="../../../assets/img/160x160/img10.jpg" alt="Image Description"> </span>
                                    </div>
                            ...
                            <!-- End Media -->
                            <!-- Media -->
                            <div class="bg-success bottom-0 d-inline-block mb-10 ms-n10 p-2 position-absolute rounded-pill shadow-sm start-0 w-100" style="max-width: 16rem;">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <span class="avatar avatar-sm avatar-circle"> <img class="avatar-img" src="../../../assets/img/160x160/img3.jpg" alt="Image Description"> </span>
                                    </div>
                                    <div class="flex-grow-1 ms-2">
                    ...
                    <div class="row align-items-lg-center">
                        <div class="col-lg-7 me-auto ms-lg-n10 mb-5 mb-lg-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-3 h-auto">
                                    <img class="rounded-3" src="../../../assets/img/400x700/1.jpg" alt="Image Description" width="196">
                                </div>
                                <!-- End Col -->
                                <div class="col-5">
                                    <img class="img-fluid rounded-3" src="../../../assets/img/400x700/2.jpg" alt="Image Description" width="290" style="margin-left: 47px;">
                                </div>
                                <!-- End Col -->
                            </div>
                            <!-- End Row -->
                        ...
                        <div class="col-lg-5">
                            ...
                            <ul class="list-checked list-checked-soft-bg-primary list-checked-lg">
                                ...
                                <li class="list-checked-item">Scale budgets <span class="fw-bold">efficiently</span>
                                </li>
                            </ul>
                            <!-- End List Checked -->
                        </div>
            ...
            <!-- End Features -->
            <!-- Icon Blocks -->
            <div class="container lib-features">
                <div class="row">
                    <div class="col-sm-6 col-lg-4 mb-5">
                        <div class="text-center px-md-5">
                            ...
                            <p>Pinekit is an <span class="fw-bold">incredibly beautiful</span> and mobile-first project on the web.</p>
                        </div>
                    </div>
                    <!-- End Col -->
                    <div class="col-sm-6 col-lg-4 mb-5">
                        <div class="text-center px-md-5">
                            ...
                            <p>Pinekit is not only for developers but also for designers, and <span class="fw-bold">includes a Figma</span> file.</p>
                        </div>
                    </div>
                    <!-- End Col -->
                    <div class="col-sm-6 col-lg-4 mb-5">
                        <div class="text-center px-md-5">
                            ...
                            <p><span class="fw-bold">Whether you're a startup</span> or a global enterprise, learn how to integrate with Pinekit.</p>
                        </div>
                    </div>
                    <!-- End Col -->
                    <div class="col-sm-6 col-lg-4 mb-5 mb-lg-0">
                        <div class="text-center px-md-5">
                            ...
                            <p>Use Pinekit thoroughly thought and automated libraries to <span class="fw-bold">manage your businesses</span>.</p>
                        </div>
                    </div>
                    <!-- End Col -->
                    <div class="col-sm-6 col-lg-4 mb-5 mb-sm-0">
                        <div class="text-center px-md-5">
                            ...
                            <p>Pinekit template can be <span class="fw-bold">easily customized</span> with its cutting-edge components.</p>
                        </div>
                    </div>
                    <!-- End Col -->
            ...
            <!-- End Icon Blocks -->
            <!-- Features -->
            <div class="container content-space-t-2 content-space-t-lg-3 lib-content">
                <div class="row justify-content-lg-between align-items-lg-center">
                    ...
                    <div class="col-lg-5">
                        ...
                        <ul class="list-checked list-checked-soft-bg-primary list-checked-lg mb-5">
                            <li class="list-checked-item"><span class="fw-bold">Easy &amp; fast</span> designing
                            </li>
                            <li class="list-checked-item">Powerful <span class="fw-bold">features</span>
                            </li>
            ...
            <!-- End Features -->
            <!-- Stats -->
            <div class="container content-space-2 content-space-lg-3 lib-content">
                <div class="row justify-content-lg-between align-items-lg-center">
                    <div class="col-lg-5 mb-9 mb-lg-0">
                        ...
                        <!-- Blockquote -->
                        <figure>
                            <blockquote class="blockquote"><em>Amazing people to work with. Very fast and professional partner.</em>
                            </blockquote>
                            <figcaption class="blockquote-footer">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        Josh Grazioso<span class="blockquote-footer-source">Director Payments &amp; Risk | Pinegrow</span>
                                    </div>
                                </div>
                            </figcaption>
                        </figure>
                    ...
                    <div class="col-lg-6">
                        ...
                        <ul class="list-equal-height list-equal-height-2-cols">
                            ...
                            <li class="list-equal-height-item">
                                ...
                                <p class="mb-0">faster than previous Pinekit versions</p>
                            </li>
                        </ul>
                        <!-- End List -->
                    </div>
            ...
            <!-- End Clients -->
            <!-- Card Grid -->
            <div class="container content-space-2 content-space-lg-3 lib-post-list">
                <!-- Heading -->
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3">
                    <div class="col mb-5 mb-md-0">
                        <!-- Card -->
                        <a class="card card-ghost card-transition-zoom h-100" href="#"> <div class="card-transition-zoom-item">
                    ...
                    <div class="col mb-5 mb-md-0">
                        <!-- Card -->
                        <a class="card card-ghost card-transition-zoom h-100" href="#"> <div class="card-pinned card-transition-zoom-item">
                                ...
                                <h4>Studio by Pinegrow</h4>
                                <p class="card-text">Produce professional, reliable streams easily leveraging Pinegrow's innovative broadcast studio</p>
                            </div> <div class="card-footer">
